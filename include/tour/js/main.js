  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    function switchToNextLink() {
      ...
      if (menuLinks[currentIndex]) {
        ...
        const imageUrls = menuLinks[currentIndex]
    ...
    const initialImages = menuLinks[currentIndex].getAttribute("data-images");
    if (initialImages) {
        initialImages.split(",");
    }
    menuLinks[currentIndex].classList.add("active");
    ...
    window.addEventListener("scroll", function () {
      if (window.scrollY > 50) {
        // Kiểm tra nếu cuộn trang vượt quá 50px
